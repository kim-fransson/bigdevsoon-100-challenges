  ...
  return (
    <main className={`min-h-dvh bg-white flex justify-center items-center ${lora.className}`}>
      <article className="md:max-w-4xl w-full flex md:flex-row flex-col gap-4">
        <RadioGroup orientation="vertical" className="md:order-1 order-3" value={selectedImage} onChange={setSelectedImage} aria-label="select image">
        ...
        <div className="overflow-clip md:rounded-md order-2">
          <Image
            ...
            src={selectedImage}
            alt=""
            className="md:w-auto md:h-auto w-full h-[400px] object-cover" />
        </div>
        ...
        <div className="flex-1 flex flex-col justify-start md:gap-6 md:py-3 p-4 gap-4 md:ml-4 md:order-3 order-1">
          ...
          <h3 className="text-4xl font-semibold text-gray-950">Custom Fit Polo Bear Oxford Shirt</h3>
          <p className="text-gray-700">Blue polo with a classic cut. Made of smooth and soft cotton.</p>

          <div>
            <div className="flex items-center gap-4">
              <span className="text-3xl font-semibold">$99.00</span>
              <div className="rounded-md bg-[#abccff] text-[#1a76ff] text-sm font-medium px-1 py-0.5">-25%</div>
            </div>
