...
export default function Home() {
  return (
    <main
      className="flex flex-col gap-12 min-h-screen p-12 
    bg-gradient-to-b from-slate-900 to-slate-700"
    >
      <h1 className="text-5xl font-extrabold leading-[4rem]  bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-amber-500">
